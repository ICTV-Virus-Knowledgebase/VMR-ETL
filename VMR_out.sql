...
SELECT  
      ...
      ,[alternative_name_csv] as 'Virus name(s)'
      , CONCAT([isolate_abbrev] , [abbrev_csv]) as 'Virus name abbreviation(s)'
      , CONCAT([exemplar_isolate] , [isolate_csv]) as 'Virus isolate designation'
